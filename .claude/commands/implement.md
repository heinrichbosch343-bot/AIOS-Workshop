...
After validating, check if documentation needs updating:

1. Read `docs/_index.md` — does a doc exist for what was built?
2. If a **new system** was created and no doc exists → create one using `docs/_templates/doc-system-template.md` or `docs/_templates/doc-integration-template.md`, then add it to `docs/_index.md`
3. If an **existing documented system** was significantly changed → update the relevant doc and add a dated entry to its History table
4. Minor changes within a system → skip
5. Update `HISTORY.md` with a dated entry summarizing what was implemented
