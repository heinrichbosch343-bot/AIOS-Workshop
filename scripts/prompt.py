"""
Daily Brief â€” Adaptive Mega-Prompt Builder
...
The prompt adapts to what the user actually has â€” if they don't have
...
# ============================================================
# BRIEF PRESETS â€” Configurable report structures
# ============================================================
...
def load_business_context():
    ...
    Reads whatever context files exist â€” adapts to the user's setup.
...
Your job is to SYNTHESIZE â€” not summarize. Connect dots across data sources. Spot patterns. Flag things that need attention. Be specific: names, numbers, percentages, direct quotes.

RULES:
- Total output: approximately {word_budget} words
- Use the currency specified in the funnel metrics section
- Lead with the single most important signal â€” the one thing the owner needs to know first
- Compare metrics to 7-day averages â€” say "above/below average" with specific numbers
...
- Write with conviction, not caution â€” this is a trusted advisor briefing, not a cautious report
- Use markdown headers (## for sections)
- Be specific: "$53K from 3 deals" not "good revenue day"
- If data is missing for a section, skip it entirely â€” do not write "No data available"
"""
...
def _build_section_instructions(sections, word_budget, has_meetings, has_slack, has_email=False):
    ...
    section_defs = {
        ...
        "key_signals": (
            ...
            "ðŸ”¥ = wins, momentum, deals closed\n"
            "âš ï¸ = risks, drops, blockers\n"
            "ðŸ“Œ = recurring patterns, strategic themes\n"
            "ðŸ’¡ = opportunities, ideas\n"
            "ðŸ“Š = notable metric movements\n"
        ...
        "department_analysis": (
            ...
            "Be specific â€” name people, quote them, cite patterns."
            if has_meetings
            else None
        ),
        "slack_digest": (
        ...
        "cross_stream_patterns": (
            ...
            "Skip obvious observations â€” only genuinely surprising connections."
        ...
        "strategic_recommendations": (
            ...
            "1. **Concerns** (1-3) â€” things that should worry leadership. Be specific.\n"
            "2. **Opportunities** (1-3) â€” things to capitalize on right now.\n"
            "3. **Quick SWOT** â€” 1 sentence each: Strength, Weakness, Opportunity, Threat "
...
if __name__ == "__main__":
    """Quick test â€” show what context is available."""
